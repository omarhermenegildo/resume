...
To contribute to resume project on [GitHub](https://github.com/omarhermenegildo/resume), We use Gitflow (See more [here](https://datasift.github.io/gitflow/IntroducingGitFlow.html)) In a nutshell, it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/omarhermenegildo/resume/pulls).
...
```bash
git remote add upstream  https://github.com/omarhermenegildo/resume.git
```

Now your **upstream** points to **omarhermenegildo/resume**.
...
All merge requests are automatically tested using [Github Actions](https://github.com/omarhermenegildo/resume/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
